      ...
      <Table className={classes.table} size="small" aria-label="a dense table" style={{margin: "15px", width: "98%", textAlign: "center"}}>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center">Punto de venta <ArrowDropDownIcon/></TableCell>
